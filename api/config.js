...
export const V5_DIR = path.resolve(process.env.OUTPUT_DIR_V5 || path.join(ROOT, 'saida_greenfield_v5'));
...
export const DISTRICTS_FILE = path.resolve(process.env.ARQUIVO_DISTRITOS_JSON || path.join(ROOT, 'geometria_brasil', 'Brasil_Distritos_Metro.json'));
